...
import bgImage from '../../../assets/img/facts_bg.webp';
        ...
        <div className='container pt-5 pb-4'>
          <div className='row'>
            <div className='col-sm-6 col-md-3 text-center mb-4'>
              ...
              <h4 className='facts-counter text-light'>100</h4>
            ...
            <div className='col-sm-6 col-md-3 text-center mb-4'>
              ...
              <h4 className='facts-counter text-light'>105</h4>
            ...
            <div className='col-sm-6 col-md-3 text-center mb-4'>
              ...
              <h4 className='facts-counter text-light'>28</h4>
